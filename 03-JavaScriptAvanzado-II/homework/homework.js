...
el argumento, y su valor el resultado de la correspondiente invocación a cb) de manera que, la próxima vez que reciba el mismo 
...
function cacheFunction(cb) {
  let memory = {};
  return function(arg){
    if (memory.hasOwnProperty(arg)) return memory[arg];
    memory[arg] = cb(arg)
    return memory[arg];
  }
}
...
/*
  ...
  Las funciones obtenidas deberían recibir solamente un argumento - la cadena de texto - ya que los otros argumentos 
